...
# FIx for photos!! need in function send_packet the data to stay encode, don't decode it
# NOTE - in any call to func send_packet, need to change data to be encoded
